...
export { startOfConversionDay } from "./conversion-day";
...
export function formatCurrency(value, currency = "USD", rate = USD_TO_IDR) {
  if (currency === "IDR") {
    return "Rp " + formatNumber(Math.round(value * rate));
  }
